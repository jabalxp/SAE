...
<head>
    ...
    <title>Preços - Steam Achievements Explorer</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .price-layout { grid-template-columns: 1fr; gap: 15px; }
            ...
            .game-cover { max-width: 200px; margin: 0 auto 15px; }
            
            .price-cards { grid-template-columns: repeat(2, 1fr); gap: 10px; }
        ...
        @media (max-width: 480px) {
            ...
            .game-item img { width: 35px; height: 35px; }
...
<body>
            ...
            <div class="main-panel">
                <div id="gameDisplay">
                    <div class="no-game-selected">
                        ...
                        <p data-i18n-key="noGamesFound">Escolha um jogo da lista ou pesquise para ver o histórico de preços</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        async function selectGame(appid, name) {
            ...
            try {
                // Buscar dados de preço (usando IsThereAnyDeal API simulada com dados da Steam)
                ...
                document.getElementById('gameDisplay').innerHTML = `
                    <div class="no-game-selected">
                        ...
                        <p>Não foi possível obter o histórico de preços. Tente novamente.</p>
                    </div>
                `;
            } finally {
        ...
        // Buscar histórico de preços (simulado com dados realistas)
        async function fetchPriceHistory(appid) {
            // Como não temos acesso direto ao IsThereAnyDeal, vamos simular dados de histórico
            // Em produção, você usaria a API do IsThereAnyDeal ou SteamDB
            
            try {
                // Tentar pegar preço atual da Steam
        ...
        function generatePriceHistory(basePrice, currentPrice) {
            ...
            for (let i = 11; i >= 0; i--) {
                ...
                // Preços variam entre 60% e 100% do preço base, com promoções ocasionais
                let variation = 0.8 + Math.random() * 0.2;
                
                // Simular promoções em meses específicos (junho/dezembro - Steam Sales)
        ...
        function renderGameDetails(appid, name, priceData) {
            ...
            display.innerHTML = `
                ...
                <h3 style="font-family: 'Orbitron', sans-serif; margin-bottom: 15px;">
                    <i class="fas fa-chart-line" style="color: var(--accent);"></i> Histórico de Preços (12 meses)
                </h3>
                ...
                <div class="info-cards">
                    ...
                    <div class="info-card">
                        ...
                        <div class="label">Maior Histórico</div>
                    </div>
                    <div class="info-card">
