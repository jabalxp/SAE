...
<head>
    ...
    <title>Histórico de Preços - Steam Explorer</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .game-image { width: 100%; max-width: 280px; margin: 0 auto; }
            
            .price-stats { grid-template-columns: repeat(2, 1fr); gap: 10px; }
            .price-stat-card { padding: 15px; }
            .price-stat-value { font-size: 18px; }
            
            .search-section { padding: 15px; }
            .search-input { font-size: 14px; padding: 12px 40px 12px 15px; }
            
            .wishlist-grid { grid-template-columns: repeat(2, 1fr); gap: 10px; }
            .wishlist-card { min-width: auto; }
            .wishlist-img { height: 80px; }
        ...
        @media (max-width: 480px) {
            ...
            .price-stat-card { padding: 12px; }
            .price-stat-value { font-size: 16px; }
            .price-stat-label { font-size: 10px; }
            
            .wishlist-grid { grid-template-columns: 1fr 1fr; gap: 8px; }
            .wishlist-info { padding: 10px; }
            .wishlist-name { font-size: 12px; }
        }
    </style>
</head>
<body>
        ...
        <nav class="main-nav">
            ...
            <div class="nav-menu-container">
                ...
                <div class="nav-menu-dropdown">
                    ...
                    <a href="desafio.html"><i class="fas fa-calendar-check"></i> Desafio Diário</a>
                    <a href="timeline.html"><i class="fas fa-clock-rotate-left"></i> Timeline</a>
                    <a href="hardware_check.html"><i class="fas fa-microchip"></i> Hardware Lab</a>
